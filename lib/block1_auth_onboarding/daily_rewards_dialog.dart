...
class DailyRewardsDialog extends StatelessWidget {
          ...
          child: Column(
            ...
            children: [
              ...
              Wrap(
                ...
                runSpacing: 8,
                children: [
                  _rewardBox('Day 1', '40 Gems'),
                  _rewardBox('Day 2', 'Card 1'),
                  _rewardBox('Day 3', '50 Gems'),
                  _rewardBox('Day 4', '90 Gems'),
                  _rewardBox('Day 5', '120 Gems'),
                  _rewardBox('Day 6', '180 Gems'),
                  _rewardBox('Day 7', '🎁 200 Gems'),
                ],
              ),
              const SizedBox(height: 20),
              ElevatedButton(
                style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFFE94057), minimumSize: const Size(double.infinity, 45)),
                onPressed: () {
  ...
  Widget _rewardBox(String day, String reward) {
    return Container(
      width: 70,
      height: 70,
      decoration: BoxDecoration(color: Colors.black26, borderRadius: BorderRadius.circular(12), border: Border.all(color: Colors.pinkAccent)),
      child: Column(
