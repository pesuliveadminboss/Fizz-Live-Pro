          ...
          children: [
            Container(
              ...
              child: ClipRRect(
                ...
                child: Image.network('https://i.ibb.co/3k5fB0K/fizz-logo.png', errorBuilder: (c, e, s) => const Icon(Icons.videocam, size: 55, color: Colors.pink)),
              ),
            ),
            ...
            SafeArea(
              child: Column(
                children: [
                  ...
                  const Spacer(),
                  Container(
                    height: 80, width: double.infinity, padding: const EdgeInsets.symmetric(horizontal: 12),
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            top: 40, right: 16, width: 90, height: 125,
            child: Container(
              decoration: BoxDecoration(border: Border.all(color: Colors.pink, width: 2), borderRadius: BorderRadius.circular(10)),
              child: ClipRRect(borderRadius: BorderRadius.circular(8), child: _camView ?? const Center(child: CircularProgressIndicator(strokeWidth: 2, color: Colors.pink))),
            ),
          ),
