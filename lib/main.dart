                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            if (_chatCtrl.text.isNotEmpty) {
                              setState(() => _chat.add('You: ${_chatCtrl.text}'));
                              _chatCtrl.clear();
                            }
                          },
                        ),
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: [
                ...
                IconButton(
                  icon: const Icon(Icons.call_end, color: Colors.red, size: 34),
                  onPressed: () => Navigator.pop(context),
                ),
                IconButton(
                  icon: const Icon(
